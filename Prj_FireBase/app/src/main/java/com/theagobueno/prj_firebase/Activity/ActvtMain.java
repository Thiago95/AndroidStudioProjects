...
public class ActvtMain extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFazerLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentFazerLogin = new Intent(ActvtMain. this, LoginActivity.class);
                startActivity(intentFazerLogin);
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.actvt_main, menu);
        return true;
    }
