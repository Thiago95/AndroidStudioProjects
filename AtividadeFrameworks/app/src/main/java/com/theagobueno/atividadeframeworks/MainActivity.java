...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayInputDialog(final int pos)
    {
        ...
        final EditText nameEditTxt= (EditText) d.findViewById(R.id.nameEdtTxt);
        ...
        }else
        {
            ...
            nameEditTxt.setText(crud.getName().get(pos));
        }
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name.length()>0 && name != null)
                {
                    ...
                    crud.save(name);
                    nameEditTxt.setText("");
                    adapter=new ArrayAdapter<String>(MainActivity.this,android.R.layout.simple_list_item_1,crud.getName());
                    lv.setAdapter(adapter);
                }else
                {
                    Toast.makeText(MainActivity.this, "O nome não pode estar vazio", Toast.LENGTH_SHORT).show();
                }
            }
        });
